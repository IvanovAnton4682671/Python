...
f_list = []
shape_list = [[1, 1, 2, 2, "Отрезок1"], [3, 3, 4, 4, "Отрезок2"], [5, 5, 6, 6, "Отрезок3"],
             [7, 7, 8, 8, "Отрезок4"], [9, 9, 10, 10, "Отрезок5"], [-1, -20, -3, -4, 5, "Параллелограмм1"],
             [2, 3, 4, 5, 4, "Параллелограмм2"], [1, 1, 3, 10, 3, "Параллелограмм3"],
             [10, 5, 2, 8, 3, "Параллелограмм4"], [1, 12, 23, 2, 30, "Параллелограмм5"],
             [1, 12, 2, 2, 30, "Трапеция1"], [5, 1, 10, 2, 3, "Трапеция2"], [2, 5, 5, 2, 3, "Трапеция3"],
             [7, 4, 2, 4, 3, "Трапеция4"], [10, 1, -2, 2, 35, "Трапеция5"]]
shape_color_list = ["null", "null", "null", "null", "null", "red", "green", "blue", "purple", "yellow", "brown",
                    "light_blue", "black", "white", "dark_blue"]
